    ...
    <div className="bg-[#F2F2F7] min-h-screen pb-24">
      <header className="px-6 pt-12 pb-6">
        <div className="flex items-center gap-4">
            ...
            <div>
                <h1 className="text-2xl font-bold text-gray-900">自律达人</h1>
      ...
      <main className="px-4 space-y-4">
        <section className="bg-white rounded-2xl overflow-hidden shadow-sm">
            <div className="p-4 border-b border-gray-100 flex items-center justify-between active:bg-gray-50 transition-colors">
                <div className="flex items-center gap-3">
                    <span className="w-8 h-8 rounded-full bg-blue-100 flex items-center justify-center text-blue-600"><i className="fas fa-crown"></i></span>
            ...
            <div className="p-4 flex items-center justify-between active:bg-gray-50 transition-colors">
                 <div className="flex items-center gap-3">
                    <span className="w-8 h-8 rounded-full bg-orange-100 flex items-center justify-center text-orange-600"><i className="fas fa-medal"></i></span>
        ...
        <button className="w-full py-4 text-red-500 font-bold bg-white rounded-2xl shadow-sm active:bg-gray-50 transition-colors">
            退出登录
        </button>
      </main>
    </div>
